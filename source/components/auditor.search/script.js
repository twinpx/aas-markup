(function ($) {
  ...
  $(function () {
    ...
    if (urlQuery.field && urlQuery.sort) {
      var $thElements = $('.b-auditor-search th');
    ...
    //tr click
    // $( '.b-auditor-search' ).delegate( 'tbody tr', 'click', function() {
    //   window.location = $( this ).data( 'url' );
    // });

    //th click, sorting
    $('.b-auditor-search th').click(function () {
      var $th = $(this);
      ...
      $.ajax({
        ...
        success: function (json) {
          if (typeof json === 'object' && json.TBODY && json.PAGINATION) {
            ...
            //set pagination
            var $pagination = $('.b-auditor-search .b-pagination-block');
