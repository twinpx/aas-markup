          ...
          try {
            ...
            switch (type) {
              ...
              case 'content':
                ...
                break;
              case 'count':
                nc.innerHTML = `<span class="notification notification--count"><span>${result.response.CONTENT}</span></span>`;
                break;
            }
            //events
            setTimeout(() => {
              ...
              //clear
              nc.querySelector('.notification__clear').addEventListener(
                'click',
                (e) => {
                  e.preventDefault();
                  //hide
                  nc.classList.remove('notification--show');
                  if (type === 'top') {
                    document
                      .querySelector('body')
