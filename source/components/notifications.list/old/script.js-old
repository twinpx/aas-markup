(function ($) {
  ...
  $(function () {
    ...
    if (urlQuery.field && urlQuery.sort) {
      var $thElements = $('.b-notifications-list th');
    ...
    //tr click
    // $( '.b-notifications-list' ).delegate( 'tbody tr', 'click', function() {
    //   window.location = $( this ).data( 'url' );
    // });

    //th click, sorting
    $('.b-notifications-list th').click(function () {
      var $th = $(this);
      ...
      $.ajax({
        ...
        success: function (json) {
          if (typeof json === 'object' && json.TBODY && json.PAGINATION) {
            ...
            //set pagination
            var $pagination = $('.b-notifications-list .b-pagination-block');
