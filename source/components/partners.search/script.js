(function ($) {
  ...
  $(function () {
    ...
    if (urlQuery.field && urlQuery.sort) {
      var $thElements = $('.b-partners-search th');
    ...
    //tr click
    // $( '.b-partners-search' ).delegate( 'tbody tr', 'click', function() {
    //   window.location = $( this ).data( 'url' );
    // });

    //th click, sorting
    $('.b-partners-search th').click(function () {
      var $th = $(this);
      ...
      $.ajax({
        ...
        success: function (json) {
          if (typeof json === 'object' && json.TBODY && json.PAGINATION) {
            ...
            //set pagination
            var $pagination = $('.b-partners-search .b-pagination-block');
